...
Workflow.grid.Chunks = function (config) {
    config = config || {};
    ...
    Workflow.grid.Chunks.superclass.constructor.call(this, config)
};
Ext.extend(Workflow.grid.Chunks, MODx.grid.Grid, {
...
Ext.reg('workflow-grid-chunk', Workflow.grid.Chunks);
...
Workflow.window.ChangeCategory = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        ,fields: [{
            ...
            ,id: 'workflow-chunk-category-combo'
...
Ext.reg('workflow-chunk-window-change-category', Workflow.window.ChangeCategory);
