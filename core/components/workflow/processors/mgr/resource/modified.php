<?php
/**
 * Get modified resources since last login
 *
...
$c->select($modx->getSelectColumns('modResource','modResource', '', array('id', 'pagetitle', 'published', 'publishedon')));
$c->select(array(
    'status' => $modx->getSelectColumns('modTemplateVarResource','TemplateVarResources', '', array('value')),
    ));
$count = $modx->getCount('modResource', $c);
return $modx->error->success('', array('count' => $count));